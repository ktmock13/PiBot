...
class InputWindow:
    def __init__(self, robot):
        ...
        self.robot.root.bind('<Left>', lambda event: robot.arm.directionalMove('L'))
        self.robot.root.bind('<Right>', lambda event: robot.arm.directionalMove('R'))
        self.robot.root.bind('<Up>', lambda event: robot.arm.directionalMove('U'))
        self.robot.root.bind('<Down>', lambda event: robot.arm.directionalMove('D'))
        ...
        self.robot.root.bind('p', lambda event: robot.arm.printSettings())
        self.robot.root.bind('c', lambda event: robot.arm.goToCenter())
